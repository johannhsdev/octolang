# Guía de Esquema de soprte octolang para svelte laravel
---

<requerimiento>
vamos ahora a construir el soporte para svelte, debemos seguir los mismos criterios que ya tenemos establecidos para el proyecto[
    {paquete}/lang/{locale}/{file}.php
    componente octoloang\OctoLangSwitch
    integrar la info en el archivo welcome no borrar ni reemplazar el contenido por defecto del welcome.
    reactividad en definicion del APP_LOCALE para siempre establecer el idioma por defecto
]

muestra de como es el welcome.blade de livewire
```
<script lang="ts">
...
<salida>
realiza un plan para esto usa siempre /laravel-package-architect
</salida>